...
export const IconSidebar: React.FC<IconSidebarProps> = ({ activeView, onNavigate }) => {
    return (
        <nav className="flex flex-col items-center w-20 bg-gray-800 text-white shadow-lg z-20 flex-shrink-0">
            <button onClick={() => onNavigate('dashboard')} className="flex items-center justify-center w-full h-24 border-b-2 border-gray-700 hover:bg-gray-700/50 transition-colors duration-200">
                <img src="/framo-logo.png" alt="Framo Logo" className="h-16 w-16 rounded-2xl object-cover" />
            </button>
